...
export const Nautic: React.FC<State> = ({ onTypeChange }) => {
	...
	// 		safeCatalogue.filter((item: Catalogue) => item.category === category)[0].price ?? 0,
	// 	);
	...
	useEffect(() => {
		...
		fetchNui("boutiqueVehSelect", { ...selectedVehicule, category: "bateaux" });
	}, [selectedVehicule]);

	console.log("Catégories disponibles (Nautic) :", vehiculeCategories);
	console.log("safeCatalogue (Nautic) :", safeCatalogue);
				...
				<div className="BoutiqueVehicules">
					<div className="Header">
						...
						<div className="TopButton">
							<span
								...
								<p style={{ background: "linear-gradient(180deg, #d850ca 0%, #db6bdd 100%)" }}>{premium ? "Premium" : "Non Premium"}</p>
								Premium
							</span>
							<span
								onClick={() => {
					...
					{selectedVehicule && (
						<div className="Content">
							<div className="Left">
								...
								<div className="TypeChange">
									<div className="buttons">
										...
										<div className="button active"> <img src={NauticIcon} /> </div>
										<div className="button" onClick={() => onTypeChange("air")}> <img src={AirIcon} /> </div>
									</div>
									<div className="title">
										<img src={NauticIcon} />
										Nautiques
							...
							<div className="Right">
								{/* --- DÉBUT DÉSACTIVATION TEMPORAIRE DES CATÉGORIES NAUTIQUES --- */}
								{/*
