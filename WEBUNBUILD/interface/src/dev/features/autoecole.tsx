...
import {IAutoEcoleData} from "@/features/Autoecole/types.ts";

export const Autoecole = (visible: boolean) => {
    debugData([
        {
    ...
    [
        ...
        },
        {
            ...
            "answer": [
                ...
                {
                    "letter": "B",
                    "name": "Je mets les warning pour prévenir les autres conducteurs que je risque de m'évanouir",
                    "selected": false
                },
                {
                    "letter": "C",
                    "name": "J’incline mon siège au maximum pour pouvoir conduire et me reposer en même temps",
                    "selected": false
                },
        ...
        },
        {
            ...
            "answer": [
                {
                    "letter": "A",
                    "name": "J’en profite pour le dépecer et me faire de l’argent sur son dos",
                    "selected": false
                },
