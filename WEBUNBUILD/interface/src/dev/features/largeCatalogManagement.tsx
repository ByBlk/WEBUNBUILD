...
export const largeCatalogManagement = (visible: boolean) => {
  debugData([
    {
      action: 'nui:large-catalog-management:data',
      data: mockData
    }
  ]);
  debugData([
    {
      action: 'nui:large-catalog-management:visible',
      data: visible
    }
  ]);
}
...
const mockData = {
  ...
  buttons: [
    ...
    },
    {
      ...
      forceHeader: { headerSubName: 'haut' },
      width: "full",
