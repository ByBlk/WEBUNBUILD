...
export const Job: React.FC<INotificationPresetProps> = ({ distance = 0, distancepnj = 0, ...props }) => {
  return <div className={"_notification showAnnonce" + (props?.staffReason ? " staff" : "") + ' ' + props?.mainColor}  >
    <div className="img">
      <img src={props.logo} />
    </div>
    <div className="infos">
      ...
      <div
        className={props.typeannonce?.toLowerCase() + " notifTag"}
      >
      ...
      {!props.staff && props?.phone && (
        <MediaCdn path={"assets/hud/notifications"} name={"green-phone.webp"} props={{
